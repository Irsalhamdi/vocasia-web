...
class PaymentModel extends Model
{
  ...
  protected $allowedFields        = ['id_user', 'id_payment', 'payment_type', 'payment_bank', 'payment_va', 'coupon', 'course_id', 'amount', 'admin_revenue', 'instructor_revenue', 'instructor_payment_status', 'code_trans', 'status_payment', 'status'];
