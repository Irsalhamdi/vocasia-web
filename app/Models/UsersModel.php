...
class UsersModel extends Model
{
    ...
    {
        return $this->db->table('users a')->select("a.first_name,a.last_name,b.biography,b.datebirth,b.phone")->join('user_detail b', 'b.id_user = a.id')->where('b.id_user', $id_user)->get()->getRow();
    }
